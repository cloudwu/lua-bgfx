...
#define BGFX_HANDLE_FRAME_BUFFER 7
#define BGFX_HANDLE_INDIRECT_BUFFER 8
#define BGFX_HANDLE_TEXTURE 9
#define BGFX_HANDLE_UNIFORM 10
#define BGFX_HANDLE_OCCLUSION_QUERY 11
